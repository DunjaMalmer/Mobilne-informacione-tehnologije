...
import 'package:projekatmobilne/screen/cart/bottom_checkout.dart';
import 'package:projekatmobilne/screen/cart/cart_widget.dart';
    ...
    return isEmpty
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              title: const Text("Poslasticarnica"),
              actions: [
                IconButton(
                  onPressed: () {},
